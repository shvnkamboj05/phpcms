...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" ><!-- starting main navbar-->
 ...
 <!--div class="wrapper">
       <img src="images/webdesignImage.jpg" alt="Blog" class="img-responsive" alt="Responsive image">
 

<div class="carousel-caption">
          <h3>BLOG</h3>
          <p>Spend more time observing than talking.</p>
